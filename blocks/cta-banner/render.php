...
<section<?php stech_block_attrs( $block, 'cta-banner' ); ?>>
	<div class="container">
		...
		if ( $p ) :
			?>
			<a class="btn btn--primary" href="<?php echo $p['url']; // esc'd in helper. ?>"<?php echo $p['target'] . $p['rel']; ?>><?php echo $p['title'] ?: esc_html__( 'Get Started', 'stech' ); ?> <span class="arrow" aria-hidden="true">&rarr;</span></a>
		<?php endif; ?>
		<?php
